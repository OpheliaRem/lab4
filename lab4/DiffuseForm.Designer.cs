namespace lab4
{
	partial class DiffuseForm
	{
		...
		private void InitializeComponent()
		{
			...
			listBox.Location = new Point(256, 22);
			...
			groupBox1.Size = new Size(404, 450);
			...
			label8.Location = new Point(33, 353);
			label8.Name = "label8";
			...
			// textBoxTimeStep
			// 
			textBoxTimeStep.Location = new Point(33, 371);
			...
			// buttonCalculate
			// 
			buttonCalculate.Location = new Point(215, 351);
			buttonCalculate.Name = "buttonCalculate";
			buttonCalculate.Size = new Size(141, 61);
			...
			// textBoxWindPhi
			// 
			textBoxWindPhi.Location = new Point(33, 247);
			...
			// textBoxWindAbs
			// 
			textBoxWindAbs.Location = new Point(33, 189);
			...
			buttonDelete.Location = new Point(256, 227);
			...
			// buttonAddQ
			// 
			buttonAddQ.Location = new Point(54, 105);
